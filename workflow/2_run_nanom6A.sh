...
# for example : 
# export PATH=/home/Sorata/Software/nanom6A_2021_3_18:$PATH
...
if [ ! -d "$dir" ]; then
        ...
        echo '-----------------------------------------------'
        mkdir -p $dir/plot
        python spredict_sites.py --cpu $threads -i $output/extract_raw_and_feature/$lib -o $dir -r $bed -g $genome --model $model
